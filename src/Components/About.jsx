...
function About() {
  return (
    <div className="about-container">
      ...
      <p>
        Welcome to <strong>Journal</strong>, your all-in-one platform for managing and exploring
      ...
      <ul>
        ...
        <li><strong>Seamless Collaboration</strong> – Work efficiently with teams and keep track of contributions.</li>
        <li><strong>Reliable & Secure</strong> – Ensure data integrity and access when you need it.</li>
      </ul>
